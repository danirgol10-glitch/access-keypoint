...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'trading.findCollectors': 'Find collectors through friends or university.',
    'trading.discoverySubtitle': 'Discover collectors and trade stickers',
    'friends.suggestedDesc': 'People from your university',
