  ...
  public: {
    Tables: {
      ...
      trade_request_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "trade_request_items_sticker_id_fkey"
            columns: ["sticker_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "trade_request_items_trade_request_id_fkey"
            columns: ["trade_request_id"]
            isOneToOne: false
            referencedRelation: "trade_requests"
            referencedColumns: ["id"]
      ...
      trade_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "trade_requests_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "trade_requests_from_user_id_fkey"
          ...
          {
            foreignKeyName: "trade_requests_to_user_id_fkey"
            columns: ["to_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Functions: {
      get_report_count: { Args: { target_user_id: string }; Returns: number }
    }
    Enums: {
      [_ in never]: never
    }
